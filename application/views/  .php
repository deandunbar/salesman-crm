...
<head>
    ...
    <link href="<?php echo base_url(); ?>matrix/themes/sbadmin/css/jquery.dynatable.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Salesman CRM</a>
            </div>
            <!-- /.navbar-header -->
...
<?php echo $main_content;?>
    ...
    <script src="<?php echo base_url(); ?>matrix/themes/sbadmin/js/sb-admin-2.js"></script>
     <script src="<?php echo base_url(); ?>matrix/themes/sbadmin/js/jquery.dynatable.js"></script>
